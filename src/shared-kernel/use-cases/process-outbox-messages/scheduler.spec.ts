...
function createSystemUnderTest() {
  ...
  const stubConfigService = { getOrThrow: vitest.fn(() => OUTBOX_PROCESSING_INTERVAL) } as unknown as ConfigService
  ...
  const scheduler = new ProcessOutboxMessagesScheduler(stubConfigService, useCase);
